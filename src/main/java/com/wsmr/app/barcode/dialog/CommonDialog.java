package com.wsmr.app.barcode.dialog;
...
public class CommonDialog {
    ...
    public static void showAsciiStringDialog(Context context, int title, String value,
                                        final IAsciiStringDialogListener listener) {

        LinearLayout root = (LinearLayout) LinearLayout.inflate(context, R.layout.dialog_input_ascii_string, null);
        final EditText edtValue = (EditText) root.findViewById(R.id.value);
        edtValue.setText(value);
        edtValue.selectAll();
    ...
    public interface IAsciiStringDialogListener {
        void onConfirm(String value, DialogInterface dialog);
    }
