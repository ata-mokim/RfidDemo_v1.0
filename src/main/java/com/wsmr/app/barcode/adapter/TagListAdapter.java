...
public class TagListAdapter extends BaseAdapter {
    ...
    public boolean ismIsAsciiMode() {
        return mIsAsciiMode;
    }

    public void setmIsAsciiMode(boolean enabled) {
        mIsAsciiMode = enabled;
        notifyDataSetChanged();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.setItem(mList.get(position), mIsDisplayPc, mIsVisibleRssi, mIsAsciiMode);
    ...
    private class TagListViewHolder {
        ...
        public void setItem(TagListItem item, boolean displayPc,
                            boolean visibleRssi, boolean asciimode) {
            if (displayPc) {
                if (asciimode){
                    txtTag.setText(StringUtil.hexToAscii(item.getTag()));
                }else {
                    txtTag.setText(item.getTag());
                }
            } else {
                if (asciimode){
                    txtTag.setText(StringUtil.hexToAscii(item.getTag().substring(PC_LEN)));
                }else {
 ...
 /*           if (asciimode) {
                txtTag.setText(StringUtil.convertHexToString(item.getTag()));
            } else {
                txtTag.setText(item.getTag());
            }*/
