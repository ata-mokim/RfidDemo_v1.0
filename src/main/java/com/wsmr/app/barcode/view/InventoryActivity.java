...
import com.wsmr.app.barcode.adapter.TagListAdapter;
...
//import static com.wsmr.app.barcode.util.StringUtil.convertHexToString;
...
public class InventoryActivity extends ActionActivity implements OnCheckedChangeListener, OnItemSelectedListener {
    ...
    private static final int SETUP_ACTIVITY = 4;
    ...
    /**
     * Instantiates a new Inventory activity.
     */
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            ...
            case R.id.report_rssi:
                ...
                break;
            case R.id.ascii_mode:
                GlobalInfo.setAsciiMode(chkAsciiMode.isChecked());
                adpTags.setmIsAsciiMode(GlobalInfo.isAsciiMode());
                break;
        }
    }
    ...
    protected void initWidgets() {
        ...
        // Ascii Mode Check Box
        chkAsciiMode = (CheckBox) findViewById(R.id.ascii_mode);
        chkAsciiMode.setOnCheckedChangeListener(this);
        ...
        btnSetup = (Button) findViewById(R.id.msetup);
        btnSetup.setEnabled(true);
        btnSetup.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentSubActivity =
                        new Intent(InventoryActivity.this, OptionActivity.class);
    ...
    protected void enableWidgets(boolean enabled) {
        ...
        if (mReader.getAction() == ActionState.Stop) {
            ...
            chkAsciiMode.setEnabled(enabled);
    ...
    protected void activateReader() {
        ...
        chkAsciiMode.setChecked(GlobalInfo.isAsciiMode());
        chkReportRssi.setChecked(mIsReportRssi);
        adpTags.setDisplayPc(GlobalInfo.isContinuousMode());
        adpTags.setDisplayPc(GlobalInfo.isAsciiMode());
        adpTags.setVisibleRssi(chkReportRssi.isChecked());
